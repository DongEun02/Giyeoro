...
const CANDIDATE_REPOSITORIES: readonly CandidateRepository[] = [
  ...
  { fullName: "date-fns/date-fns", languages: ["TypeScript", "JavaScript"], dependencyPatterns: ["date-fns"] },
  { fullName: "colinhacks/zod", languages: ["TypeScript", "JavaScript"], dependencyPatterns: ["zod"] },
  { fullName: "immerjs/immer", languages: ["JavaScript", "TypeScript"], dependencyPatterns: ["immer"] },
  { fullName: "floating-ui/floating-ui", languages: ["TypeScript", "JavaScript"], dependencyPatterns: ["@floating-ui/"] },
  { fullName: "react-hook-form/react-hook-form", languages: ["TypeScript", "JavaScript"], dependencyPatterns: ["react-hook-form"] },
  { fullName: "faker-js/faker", languages: ["TypeScript", "JavaScript"], dependencyPatterns: ["@faker-js/faker", "faker"] },
  { fullName: "uuidjs/uuid", languages: ["TypeScript", "JavaScript"], dependencyPatterns: ["uuid"] },
  { fullName: "testing-library/react-testing-library", languages: ["JavaScript", "TypeScript"], dependencyPatterns: ["@testing-library/react"] },
  { fullName: "testing-library/dom-testing-library", languages: ["JavaScript", "TypeScript"], dependencyPatterns: ["@testing-library/dom"] },
  { fullName: "TanStack/query", languages: ["TypeScript", "JavaScript"], dependencyPatterns: ["@tanstack/react-query", "react-query"] },
  { fullName: "psf/requests", languages: ["Python"], dependencyPatterns: ["requests"] },
  { fullName: "encode/httpx", languages: ["Python"], dependencyPatterns: ["httpx"] },
  { fullName: "pallets/click", languages: ["Python"], dependencyPatterns: ["click"] },
  { fullName: "marshmallow-code/marshmallow", languages: ["Python"], dependencyPatterns: ["marshmallow"] },
  { fullName: "python-attrs/attrs", languages: ["Python"], dependencyPatterns: ["attrs"] },
  { fullName: "HypothesisWorks/hypothesis", languages: ["Python"], dependencyPatterns: ["hypothesis"] },
  { fullName: "google/gson", languages: ["Java", "Kotlin"], dependencyPatterns: ["com.google.code.gson", "gson"] },
  { fullName: "mockito/mockito", languages: ["Java", "Kotlin"], dependencyPatterns: ["org.mockito", "mockito"] },
  { fullName: "assertj/assertj", languages: ["Java", "Kotlin"], dependencyPatterns: ["org.assertj", "assertj"] },
  { fullName: "square/moshi", languages: ["Kotlin", "Java"], dependencyPatterns: ["com.squareup.moshi", "moshi"] },
  { fullName: "Kotlin/kotlinx.serialization", languages: ["Kotlin"], dependencyPatterns: ["kotlinx-serialization"] },
  { fullName: "coil-kt/coil", languages: ["Kotlin"], dependencyPatterns: ["io.coil-kt", "coil"] },
  { fullName: "stretchr/testify", languages: ["Go"], dependencyPatterns: ["github.com/stretchr/testify"] },
  { fullName: "go-playground/validator", languages: ["Go"], dependencyPatterns: ["github.com/go-playground/validator"] },
  { fullName: "samber/lo", languages: ["Go"], dependencyPatterns: ["github.com/samber/lo"] },
  { fullName: "serde-rs/json", languages: ["Rust"], dependencyPatterns: ["serde_json"] },
  { fullName: "tokio-rs/bytes", languages: ["Rust"], dependencyPatterns: ["bytes"] }
];
