...
const LANDING_PREVIEW_ISSUES = [
  { repo: "TanStack/query", meta: "Open · Bug", title: "ErrorBoundary retry behavior", badge: "분석 중" },
  { repo: "facebook/react", meta: "Open · Compiler", title: "Compiler serialization issue", badge: "핵심 정리" },
  { repo: "vercel/next.js", meta: "Good first issue", title: "Dynamic route in symlink", badge: "추천" },
  { repo: "TanStack/query", meta: "Open · Help wanted", title: "StackBlitz example behavior", badge: "분석 대기" }
];
...
export function LandingPage() {
  ...
  return (
    <div className="landing-home about-page animate-fade-in">
      <section className="landing-intro">
        ...
        <div className="landing-intro-content">
          <h1>기여로에서 첫 오픈소스 기여를<br />시작하세요.</h1>
      ...
      <section className="about-problem" aria-labelledby="about-problem-heading">
        <div>
          ...
          <h2 id="about-problem-heading">좋은 첫 이슈를 찾는 것부터 어렵기 때문에</h2>
        </div>
        <p>
        ...
        <div className="about-access-grid">
          ...
          <article className="about-access-card about-access-card-github">
            ...
            {authUser ? (
              ...
              <a href={getGithubLoginUrl("/")}><Icons.Github className="w-4 h-4" /> GitHub로 시작하기</a>
            )}
          </article>
        </div>
